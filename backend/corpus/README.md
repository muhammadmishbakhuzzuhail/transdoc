...
> non-Latin "no eng backstop" fix: greek 5.4%→2.7%, russian 0.7%→0.5% CER; and the Latin
> script-model fix: portuguese 3.0%→0.04% CER once `tesseract-ocr-script-latn` is installed —
> bare `eng` drops ç/ã/â/í).
>
